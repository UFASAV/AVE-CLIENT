...
function client:console(Message)
	...
	Msger.Text = "[AVE]: "
	Msger.TextColor3 = Color3.fromRGB(65, 105, 225)
...
if identifyexecutor then
	...
	if not supported then
		for i = 1, 10 do
            client:console("AVE is discontinued. Please don't add me asking about it. Thanks")
        end
	end
end
-- !! CANCER BELOW !! --
...
library.flags['Menu Accent Color'] = Color3.fromRGB(65, 105, 225)
library:Init()
client:init()
...
for i = 1, 10 do
    client:console("Ceri is discontinued. Please don't add me asking about it. Thanks")
end
